...
public class WordStatCount {
    ...
    public static void main(String[] args) {
        ...
        try { //Проверка на существование файла и на ошибку кодировки у Reader
            Reader reader = new BufferedReader(new InputStreamReader(new FileInputStream(args[0]), "UTF-8"));
            int read = 0;
            try { // Проверка на IOException в методе read()
...
/* public static safeClose(BufferedReader reader) {
        if (reader != null) {
            try {
                reader.close();
            } catch (IOException e) {
            ...
            System.err.println("Reader wasn't declared " + e.getMessage());
        }
