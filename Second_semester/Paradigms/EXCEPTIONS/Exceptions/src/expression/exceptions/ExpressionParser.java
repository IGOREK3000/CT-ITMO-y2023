...
public class ExpressionParser extends BaseParser implements TripleParser, ListParser {
    ...
    private Set<String> operations = new HashSet<>(Set.of("+", "-", "*", "/"));

    private Map<Character, Character> brackets = new HashMap<>(Map.of(
            '(', ')',
            '[', ']',
            '{', '}'
    ));
    ...
    public MainExpression parse(String expression) throws ParsingException {
